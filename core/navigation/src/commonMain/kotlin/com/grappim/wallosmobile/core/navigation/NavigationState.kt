package com.grappim.wallosmobile.core.navigation
 ...
 * route imports. See plan §5.2 and §5.5 — `SavedStateConfiguration.DEFAULT` is rejected outright
 * by `rememberNavBackStack`.
 */
@Composable
